...
async function main() {
  ...
  const configs = [
    ...
    { clave: "precio_mensual_moto", valor: "8000" },
    { clave: "precio_mensual_auto", valor: "15000" },
    { clave: "precio_mensual_suv",  valor: "20000" },
    { clave: "precio_mensual_media_moto", valor: "5000" },
    { clave: "precio_mensual_media_auto", valor: "9000" },
    { clave: "precio_mensual_media_suv",  valor: "12000" },
    { clave: "precio_media_moto", valor: "600" },
    { clave: "precio_media_auto", valor: "1200" },
    { clave: "precio_media_suv",  valor: "1800" },
    { clave: "precio_diaria_moto", valor: "1000" },
